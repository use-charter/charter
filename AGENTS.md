...
- Phase: Phase 1 Slice 8 implemented on top of the real `charter doctor` path.
...
- CLI: `charter doctor` (`--path --threshold --quiet --format text|json|markdown|sarif --out`), `charter suppress`

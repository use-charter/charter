...
**Evidence:** Last-modified date of the agent context file. List any specific factual mismatches found (e.g., 'AGENTS.md says Node 18, mise.toml pins Bun 1.3.13' or 'AGENTS.md does not mention charter serve but .mcp.json configures it').  

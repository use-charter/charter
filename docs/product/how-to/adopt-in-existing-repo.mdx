...
Then open a pull request to add CI. Use the workflow file Charter generated at `.github/workflows/charter.yaml`, or follow the [GitHub Actions guide](/ci/github-action).

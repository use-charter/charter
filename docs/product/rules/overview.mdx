...
<Note>
  ...
  **Hard caps:** Any active Blocker holds the final score at ≤ 59. Any active secret finding (AE-SEC-001 or AE-SEC-002) holds the final score at ≤ 49. Caps apply after the base formula.
</Note>

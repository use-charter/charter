...
<Steps>
  <Step title="Install Charter">
    ...
    <Tip>
      On Windows or if you prefer a direct binary or `go install`, see the [Installation guide](/installation) for all supported platforms.
    </Tip>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Add Charter to CI" icon="git-branch" href="/ci/github-action">
    Gate pull requests on agent-readiness with the GitHub Action.
  </Card>
  <Card title="Understand the score" icon="chart-bar" href="/concepts/scoring-and-caps">
  ...
  <Card title="Fix a finding manually" icon="wrench" href="/how-to/use-charter-fix-safely">

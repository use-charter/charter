...
- Evidence expectations: file path and redacted secret (never the raw value); scans only tracked inventory files; untracked/gitignored local files are intentionally not scanned.

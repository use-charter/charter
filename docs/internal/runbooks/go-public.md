...
- Cloudflare account: `Tashfiq61@gmail.com` — id `9b7d6fadbaeb947d19e41decc1c56881`
- Zone: `use-charter.dev` — id `3e04f444539a35fe073ba1947c612b1b`
...
gh secret   set CLOUDFLARE_ACCOUNT_ID  --body '9b7d6fadbaeb947d19e41decc1c56881'
...
- `MINTLIFY_ORIGIN` = `charter.mintlify.dev` (default; set explicitly)
